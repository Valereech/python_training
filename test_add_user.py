...
class TestAddUser(unittest.TestCase):
    ...
    def test_add_user(self):
        ...
        self.fill_user_form(wd, User(firstname="asf", middlename="adf", lastname="adsf", nickname="adsf", title="asdf",
    ...
    def test_add_empty_user(self):
        ...
        self.login(wd, username="admin", password="secret")
        self.open_add_new_page(wd)
        self.fill_user_form(wd, User(firstname="", middlename="", lastname="", nickname="", title="",
    ...
    def fill_user_form(self, wd, user):
